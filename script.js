...
const FAMILY_MESSAGES = [
  { from: 'אמא 💕', text: "בובזליה היקר! אני אוהבת אותך וגאה בך מאוד, מאחלת כל מה שאתה מאחל לעצמך. יש לך אהבה, חברים, ויש לך אותנו ❤️ תשמור על מה שיש ואין לי ספק שתמצא את עצמך בפן המקצוע ותגיע למה שרוצה. אנחנו תמיד איתך 🦘 טאק סקאזאט'  🎂", color: '#FF6B9D' },
  { from: 'אבא 🤍', text: 'לבני הבכור והיקר אריאל,\n​מזל טוב ענק ליום הולדתך ה-29!\n​אני מסתכל עליך ופשוט גאה בגבר שצמחת להיות. אתה סולל את הדרך שלך בביטחון, בגרות ואחריות. זה מחמם לי את הלב לראות את הבית המשותף של מוש ושוש ואת הזוגיות היפה שלכם.\n​אני מאחל לך בריאות, אהבה, הצלחה, ושתמשיך לכבוש כל יעד שאתה מציב לעצמך.\n​תזכור שאני תמיד כאן בשבילך, עומד מאחוריך בכל צעד וגאה בך בכל יום מחדש.\n​אוהב אותך המון, אבא.', color: '#4ECDC4' },
  { from: 'דוד 🌟', text: 'אריאל אחי היקר \nמזל טוב ליומהולדתך \nמאחל לך את האומץ לעשות כל דבר שרק תרצה \nאחיך דוד', color: '#FFCC00' },
  { from: 'רומי 💞', text: 'אריאל אחי היקר ואהוב❤️🎈\nמזל טוב ליום הולדתך ה-29\nמאחלת לך מלא אושר בריאות,הצלחה ופרנסה בשפע \nושתמצא את עבודות חלומותיך 🥳\nוכמובן הרבה נחת ואהבה לך ולמאיה❤️\nאוהבת מלא רומי💞', color: '#FF69B4' },
  { from: 'סבא  🌺', text: "Дорогой мой любимый Ариэленька-с днем рождения тебя. Я хочу пожелать, чтобы все твои желания исполнились,чтобы ты был счастлив в этой сложной жизни и всегда выходил победителем, а еще я хочу, чтобы ты היה счастлив с Маечкой, היא מאוד טובה,я люблю Вас вдвоем. Будте счастливы יחד! סבא גרישה", color: '#C792E9' },
];
